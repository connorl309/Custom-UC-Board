...
uint32_t FalseAData[8U] = {
    0x22222222U, 0x22222222U, 0x33333333U, 0x44444444U,
    0x55555555U, 0x66666666U, 0x77777777U, 0x88888888U
};
...
uint32_t FalseBData[8U] = {
    0x22222222U, 0x77777777U, 0x66666666U, 0x55555555U,
    0x44444444U, 0x33333333U, 0x22222222U, 0x11111111U
};
uint32_t DivisorData[8U] = {
    0x22222222U, 0x33333333U, 0x44444444U, 0x55555555U,
    0x66666666U, 0x77777777U, 0x88888888U, 0x11111111U
};
...
int main(void)
{
    ...
    if ((TrueResult == SUCCESS) && (FalseResult == ERROR)) {
        common_uart_disp("MLA MUL processed successfully !\n");
    } else {
        common_uart_disp("MLA MUL processed with error !\n");
    }
    while(1);
}
