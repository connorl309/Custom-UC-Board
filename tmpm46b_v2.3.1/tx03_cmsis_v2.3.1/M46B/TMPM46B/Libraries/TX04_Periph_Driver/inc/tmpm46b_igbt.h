...
#ifndef __TMPM46B_IGBT_H
#define __TMPM46B_IGBT_H
...
/** 
  ...
  */
    ...
    typedef struct {
        ...
        uint16_t TrgCnt;        /*!< Specify the IGTRG Value of IGBT output */
...
#define IGBT_SYNSLAVE_CHNL_START                ((uint8_t)0x0C)
#define IS_IGBT_START_MODE(param)               (((param) == IGBT_CMD_START) || \
                                                 ...
                                                 ((param) == IGBT_SYNSLAVE_CHNL_START))

#define IGBT_SYNCLR_UPCN_ENABLE               ((uint8_t)0x80)
#define IGBT_SYNCLR_UPCN_DISABLE              ((uint8_t)0x00)
#define IS_IGBT_SYNCLR_VALUE(param)           (((param) == IGBT_SYNCLR_UPCN_ENABLE) || \
                                               ((param) == IGBT_SYNCLR_UPCN_DISABLE))
...
#define IS_IGBT_ACTIVE_TIMING(param1, param2)            (((param1) <  (param2)) && ((param1) > 0U))
#define IS_IGBT_INACTIVE_TIMING(param1, param2, param3)  (((param3) <  (param1)) && ((param1) <= (param2)))
#define IS_IGBT_TRG_TIMING(param1,param2)                (((param1) <= (param2)) && ((param1) > 0U))
